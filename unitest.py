# Socket programmming chat Applet by Palash Roy 

import unittest
import threading
import socket
from chat_serv import SERVER, accept_incoming_connections
...
class ClientTest(unittest.TestCase):
    ...
    def run_server(self):
        ...
        server_sock.bind(('127.0.0.1', 33300))
    ...
    def test_client(self):
        ...
        client.connect(('127.0.0.1', 33300))
        client.close()
